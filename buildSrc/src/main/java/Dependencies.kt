...
object Deps {
    ...
    // Support Library
    const val appSupport= "compile 'com.android.support:appcompat-v7:'${Versions.support}"
    const val recyclerView = "com.android.support:recyclerview-v7:${Versions.alternate_support}"
    const val cardView = "com.android.support:cardview-v7:${Versions.alternate_support}"
    ...
    const val logging_interceptor =  "com.squareup.okhttp3:logging-interceptor:${Versions.intercept_log}"
    // Glide
